...
var xhr = Ti.Network.createHTTPClient();
		...
		var label = Ti.UI.createLabel({
								    ...
								    var button = Titanium.UI.createButton({
									 ...
									 button.addEventListener('click',function(e)
											{
							 					var xhr = Ti.Network.createHTTPClient();
    	  										xhr.open('PUT','http://192.168.0.16:3000/productproducts/'+Titanium.UI.currentWindow.editproductid); 
 ...
 xhr.open('GET','http://192.168.0.16:3000/productproducts/'+Titanium.UI.currentWindow.editproductid+'/edit.json'); 
		 						xhr.send();
